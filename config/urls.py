...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version='v1',
        description="You are now in the API for Creer, Base Url: creer-pjt-105.herokuapp.com/api , This API makes use of simplejwt token with a Bearer authorization. Register: You get an access token and refesh token which you save in your local storage. For more documentation visit https://creer-pjt-105.herokuapp.com/docs",
